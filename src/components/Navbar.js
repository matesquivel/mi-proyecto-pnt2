    ...
    <nav className="bg-base-100 shadow-md">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between p-4">
        ...
        <a href="#home" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="C:\Users\mesquivel\Desktop\Logo Techce.png" className="h-8" alt="Logo" />
          <span className="self-center text-2xl font-semibold">Techce</span>
        </a>
        ...
        <label className="swap swap-rotate">
          ...
          {/* Ícono del sol */}
          <svg
            className="swap-off fill-current w-8 h-8" // Ajuste de tamaño para que sea más pequeño
          ...
          {/* Ícono de la luna */}
          <svg
            className="swap-on fill-current w-8 h-8" // Ajuste de tamaño para que sea más pequeño
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
